...
Source0:        https://download.gnome.org/sources/%{name}/0.21/%{name}-%{version}.tar.xz
...
# These are non-executable Python modules/helpers invoked with python3.
# Remove legacy executable shebangs from the installed mode-0644 files.
sed -i '1{/^#!/d;}' %{buildroot}%{_datadir}/libsecret/mock/*.py %{buildroot}%{_datadir}/libsecret/mock-service*.py
...
%changelog
* Sun Sep 20 2026 COPR Maintainer <noreply@example.invalid> - 0.21.8.2-2.1
- Match Fedora 0.21.8.2-2 source; downstream release adds mandatory full tests
- Update to 0.21.8.2, retaining Fedora GnuTLS configuration and subpackages
- Require and run upstream D-Bus, Python, JavaScript and Vala tests
- Remove misleading legacy shebangs from installed non-executable test helpers

## START: Generated by rpmautospec
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.21.7-16
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Mar 25 2026 Jan Grulich <jgrulich@redhat.com> - 0.21.7-14
